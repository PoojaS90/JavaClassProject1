...
import java.text.NumberFormat;
   ...
   public class BankTestDriver
   	...
   	/*
   	 * method to open file, read the customer information, create objects and store objects in an array 
       * method displays a front end menu to navigate through options to manage customer accounts
   	*/
   ...
   /*
   * driver method
   * Method that invokes the driver class
   */
